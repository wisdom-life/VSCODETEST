...
robot1 = DHRobot(
    [
        RevoluteDH(d=716.1, a=0, alpha=0, offset= 0),
        RevoluteDH(d=430, a=0, alpha= pi / 2, offset= 0),
        RevoluteDH(d=430, a=0, alpha= -pi / 2, offset= 0),
        RevoluteDH(d=387, a=2080, alpha=0, offset=pi /2),
        RevoluteDH(d=430, a=2080, alpha=0,offset= 0),
        RevoluteDH(d=430, a=0, alpha= pi / 2,offset= 0),
        RevoluteDH(d=716.1, a=0, alpha= -pi/2,offset= 0),
    ],
    name="TestRobot1",
)
...
robot1.plot([ 0, 0, pi / 2, pi / 2, pi , 0, 0],block=True,fellipse=True)


robot2 = DHRobot(
    [
        RevoluteMDH(d=0.7161, a=0, alpha=0, offset= pi/2),
        RevoluteMDH(d=0.430, a=0, alpha= -pi /2, offset= pi),
        RevoluteMDH(d=0.430, a=0, alpha= pi / 2, offset= pi/2),
        RevoluteMDH(d=0.378, a=2.080, alpha= 0, offset= 0),
        RevoluteMDH(d=0.430, a=2.080, alpha=0,offset= pi/2),
        RevoluteMDH(d=0.430, a=0, alpha= pi/2,offset= pi),
        RevoluteMDH(d=0.7161, a=0, alpha= pi/2,offset= 0),
    ],
    name="TestRobot2",
)

print(robot2)
robot2.plot([ 0, 0, 0, 0, 0, 0, 0])
robot2.teach()
print(robot1)
